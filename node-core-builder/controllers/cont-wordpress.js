...
// install starter theme wordpress via ssh ( note: lebih ringan dan tidak kena timeout )
exports.starter_templates_ssh = (req) => new Promise((resolve, reject) => {
    ...
    try {
        ...
        ssh.connect({
            ...
            username: req.ftp_login,
            password: req.ftp_password
          })
          .then(function() {

            // Command
            ssh.execCommand('wp starter-templates import '+req.theme_id+' --reset --yes', { cwd:req.vhosts }).then(function(result) {
